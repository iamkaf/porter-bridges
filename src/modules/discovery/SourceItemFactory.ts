...
export interface ISourceItem {
  status: 'discovered' | 'collected' | 'collecting' | 'distilling' | 'distilled' | 'failed' | 'packaging' | 'packaged' | 'bundling' | 'bundled';
  url: string;
  ...
  metadata?:
    ...
    | { url_type: string; domain: string; direct_source: boolean; specialization: string }
    | {
  ...
  error?: {
    ...
    timestamp: string;
    retry_count: number;
    phase: 'discovered' | 'collected' | 'collecting' | 'distilling' | 'distilled' | 'failed' | 'packaging' | 'packaged' | 'bundling' | 'bundled';
  };
}
