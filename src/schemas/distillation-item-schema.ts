...
export const DistillationItemSchema = z.object({
  ...
  agent: z
    .string()
    .optional()
    .describe('AI model used (e.g., claude-3-opus, gpt-4)'),
  agent_version: z
    .string()
    .optional()
    .describe('Specific version of the AI agent'),
  ...
  retry_after: z
    ...
    .datetime()
    .optional()
    .describe('When to retry after rate limiting'),
  ...
  validation_passed: z
    .boolean()
    .optional()
    .describe('Whether output passed schema validation'),

  // Distillation context
  prompt_version: z
    .string()
    .optional()
    .describe('Version of the distillation prompt used'),
  source_checksum: z
    .string()
    .optional()
    .describe('SHA-256 of the source content distilled'),
});
