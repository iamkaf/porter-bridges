...
export const DistilledContentSchema = z.object({
  minecraft_version: z.string().describe('Primary Minecraft version this content targets'),
  breaking_changes: z
    .array(SimpleBreakingChangeSchema)
    .describe('List of breaking changes identified'),
  api_updates: z.array(SimpleApiUpdateSchema).describe('List of API updates and new features'),
  migration_guides: z.array(SimpleMigrationGuideSchema).describe('Migration guides'),
