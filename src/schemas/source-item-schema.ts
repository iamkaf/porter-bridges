...
export const SourceItemSchema = z.object({
  ...
  checksum: z
    .string()
    .optional()
    .describe('SHA-256 checksum of collected content'),
  collected_at: z
    .string()
    .datetime()
    .optional()
    .describe('When collection was completed'),
  file_size_bytes: z
    .number()
    .int()
    .nonnegative()
    .optional()
    .describe('Size of collected content'),
  ...
  minecraft_version: z
    .string()
    .optional()
    .describe('Primary Minecraft version this source covers'),
  loader_type: z
  ...
  discovered_at: z
    ...
    .datetime()
    .optional()
    .describe('When this source was first discovered'),
  discovered_by: z
    .string()
    .optional()
    .describe('Method or tool that discovered this source'),
  ...
  error: z
    .object({
      code: z
        .string()
        .describe('Error type (network_error, parse_error, etc.)'),
  ...
  retry_after: z
    ...
    .datetime()
    .optional()
    .describe('When to retry after failure'),
  last_attempt_at: z
    .string()
    .datetime()
    .optional()
    .describe('Last collection attempt timestamp'),
  ...
  tags: z
    .array(z.string())
    .optional()
    .describe('Tags for categorizing this source'),
  ...
  related_sources: z
    .array(z.string())
    .optional()
    .describe('IDs of related sources'),
  ...
  last_modified: z
    ...
    .datetime()
    .optional()
    .describe('Last-Modified header from source'),
  cache_control: z
    .string()
    .optional()
    .describe('Cache-Control header information'),
